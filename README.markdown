...
Kentucky passed House Concurrent Resolution 54 in 2000 to study the adoption of bill limits, but efforts to locate a report from the committee were unsuccessful. A recent bill was filed in the Kentucky General Assembly and one of the provisions was to cap bill introductions to three in the short session and five in the long session.  The rule would not apply to the Speaker of the House or the President of the Senate.  Also, members could continue to file an unlimited number bills so long as they repealed another statutory provision.
